...
ゲストは飲食店の検索や詳細表示、会員登録するとログイン後に飲食店一覧ソート機能の利用、飲食店の予約・お気に入り登録・評価投稿等ができるシステム。
管理者権限では店舗代表者・店舗情報の作成やお知らせメールの送信、店舗代表者権限では店舗情報の作成・更新や予約情報の確認ができる。
...
- 飲食店予約情報追加・変更・削除
- 飲食店評価投稿・編集・削除機能
- 店舗代表者作成・新規店舗情報作成・利用者へのお知らせメール送信(管理者権限)
...
## csvインポートによる新規店舗情報登録(管理者権限)

管理者用管理画面内の新規店舗情報の登録で、csvファイルをインポートすることにより、新規店舗情報を登録できる。
